...
def get_dives_data(mission_id: str, min_dive: int = None, max_dive: int = None) -> pd.DataFrame:
    """
    Return all columns for divenumbers in the specified range for a given mission_id.
...
def get_map_data(mission_id: str, min_dive: int = None, max_dive: int = None, depth: int = 0) -> pd.DataFrame:
    """
...
def get_ph_drift_data(mission_id: str, min_dive: int = None, max_dive: int = None, depth: int = 450) -> pd.DataFrame:
    """
